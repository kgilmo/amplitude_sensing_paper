...
SNs = np.array([1.2,1.2,1.25,1.1,1.05,0.8,0.4574,0.2656,0.1467,0.0401,0.0559])
...
sig_bck = 1/sqrt(N)*sqrt(0.25*(1-A**2))
sig_up = (A**2)/8*(1+j0(2*theta_max)-2*j0(theta_max)**2)
delta_J_m = 2*A**(-1)*sqrt(sig_proj**2 + sig_up + sig_bck**2)
